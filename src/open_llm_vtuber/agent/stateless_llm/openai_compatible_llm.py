...
class AsyncLLM(StatelessLLMInterface):
    ...
    async def chat_completion(
        ...
        try:
            ...
            except BadRequestError as stream_error:
                if "stream" not in str(stream_error).lower():
                    raise
                logger.warning("Provider rejected streaming; retrying once in non-streaming mode.")
