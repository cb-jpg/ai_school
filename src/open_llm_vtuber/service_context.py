...
class ServiceContext:
    ...
    def __str__(self):
        return (
            ...
            f"  Character: {self.character_config.conf_name if self.character_config else 'Not Loaded'}\n"
    ...
    async def load_cache(
        ...
        logger.debug(
            "Loaded service context cache: conf_name={}, conf_uid={}, asr={}, tts={}",
    ...
    async def handle_config_switch(
        ...
        try:
            ...
            if new_character_config_data:
                ...
                logger.debug(
                    "New character config loaded: conf_name={}, conf_uid={}",
